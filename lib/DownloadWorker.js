...
module.exports = class extends EventEmitter {
    ...
    start() {
        ...
        const sessions = shouldUseMultipleConnections ? this.makePartialSessions(this.url, this.saveToPath)
            : [this.makeSimpleSession(this.url, this.saveToPath, this.maxConnections)];
